          ...
          <div className="bg-default-950/40 rounded-2xl backdrop-blur-2xl border border-white/10 overflow-hidden">
            ...
            <div className="p-8">
              ...
              <h2 className="mb-2 text-2xl font-bold text-white">
                Create your Solana token instantly
              </h2>
              <p className="text-default-300 mb-8 text-sm leading-relaxed">
                Connect your wallet to create your token. It will be added to your wallet for free.
              </p>
              ...
              <p className="mt-4 text-center text-xs text-white/30">
                You will be asked to approve 1 transaction for the token creation.
              </p>
        ...
        <div className="bg-default-950/40 mx-auto max-w-5xl overflow-hidden rounded-2xl backdrop-blur-2xl">
          <div className="grid gap-10 lg:grid-cols-2">
            <Branding
              ...
              message="Create and manage your Solana token in minutes — no code required."
            />
            <div className="lg:ps-0 flex h-full flex-col p-10">
              <div className="pb-10">
                <a href="/" className="flex">
                  <span className="text-white text-xl font-bold tracking-wide">Solana Token Creator</span>
                </a>
              </div>
